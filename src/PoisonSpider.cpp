...
PoisonSpider::PoisonSpider()
{
	...
	getTransform()->position = glm::vec2(600.0f, 200.0f);
	getRigidBody()->velocity = glm::vec2(0.0f, 0.0f);
	getRigidBody()->acceleration = glm::vec2(0.0f, 0.0f);
	getRigidBody()->isColliding = false;
	setType(CHARACTERS);
	addAbility(new SpiderBite());
...
void PoisonSpider::draw()
{
	Animate();
}

void PoisonSpider::update()
{
...
void PoisonSpider::clean()
{
}

void PoisonSpider::useCurrentAbility()
{
...
void PoisonSpider::m_buildAnimations()
{
